...
int i;
//String Buffer = "11.66,62.42,1021.43\n";
//String Buffer = "Lon,Lat:\n35.7230738,139.9876505\n";

//\nLatitude,Longitude,Height\n35.7230738,139.9876505,42.203";
//String Buffer1 = "Time:07:59:18\n";
//String Buffer2 = "Temp:11.66\n";
//String Buffer3 = "Hum:62.42\n";
//String Buffer4 = "Pre:1021.43\n";
//String Buffer = "Latitude:35.7230738\n";
String Buffer = "Longitude:139.9876505\n";
//String Buffer7 = "Alt:42.203\n";
//String Buffer = "abcdefghijklmnopqrst\n"; //23文字まで
...
void sendData(){
  ...
  //if(1){
  digitalWrite(2, HIGH); 
  Serial.print(Serial.readString()); //　cost much time to finish this command.
  int inByte = Serial.read();
  //int inByte = (int)Buffer.charAt(i);
